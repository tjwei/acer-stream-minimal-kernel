...
static void tpa2018_arg_init(void)
{
	...
	msleep(10);
	tpa2018_set_control(1, 0, 0);
	tpa2018_set_control(1, 1, 2);
	tpa2018_set_control(1, 2, 35);
	tpa2018_set_control(1, 3, 83);
	tpa2018_set_control(1, 4, 13);
	tpa2018_set_control(1, 5, 13);
	tpa2018_set_control(1, 6, 237);
...
{
	  if(command == 1){
	   tpa2018_set_control(1, 1, 12);
	   tpa2018_set_control(1, 4, 109);
	   //tpa2018_set_control(1, 6, 237);
